...
public class AudioController : SingletonMonoBehaviour<AudioController>
{
    ...
    /// </summary>
    public const string AUDIO_TOOLKIT_VERSION = "5.3";
        ...
        foreach ( var sndSubItem in sndSubItems )
        {
            if ( sndSubItem != null )
            {
                ...
                if ( audioObjRet )
                {
                    ...
                    {
                        audioObjRet._audioSource_MinDistance_Saved = audioObjRet.audio.minDistance;
                        audioObjRet._audioSource_MaxDistance_Saved = audioObjRet.audio.maxDistance;
                        audioObjRet.audio.minDistance = sndItem.audioSource_MinDistance;
                        audioObjRet.audio.maxDistance = sndItem.audioSource_MaxDistance;
                    }
                }
            }
        }
    ...
    public AudioObject PlayAudioSubItem( AudioSubItem subItem, float volume, Vector3 worldPosition, Transform parentObj, float delay, float startTime, bool playWithoutAudioObject, AudioObject useExistingAudioObj )
    {
        ...
        sndObj.audio.loop = ( audioItem.Loop == AudioItem.LoopMode.LoopSubitem || audioItem.Loop == AudioItem.LoopMode.LoopSequenceGapless );
